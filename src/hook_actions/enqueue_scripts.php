...
function londonparkourv4_scripts() {
	...
	wp_enqueue_script( 'syllabus-all-js', get_template_directory_uri() . '/src/assets/js/all_js.js', array(), filemtime(get_template_directory() . '/src/assets/js/all_js.js'), true );
