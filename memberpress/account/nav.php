...
<div class="mp_wrapper w-1/5 max-w-md min-h-screen min-w-fit bg-zinc-900 text-zinc-100 p-4 pt-24">
  ...
  <div id="mepr-account-nav" class="flex flex-col">
    ...
    <div class="mepr-nav-item py-2 <?php MeprAccountHelper::active_nav('home'); ?>">
      <a class="hover:text-emerald-500" href="<?php echo MeprHooks::apply_filters('mepr-account-nav-home-link',$account_url.$delim.'action=home'); ?>" id="mepr-account-home"><?php echo MeprHooks::apply_filters('mepr-account-nav-home-label',_x('Profile', 'ui', 'memberpress')); ?></a>
    </div>
