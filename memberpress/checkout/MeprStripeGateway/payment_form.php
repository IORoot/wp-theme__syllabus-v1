...
<?php else: ?>
  ...
  <div class="mp-form-row">
    <div class="mp-form-label flex flex-col">
      <label><?php _e('Name on the card:*', 'memberpress'); ?></label>
      <span class="cc-error text-red-500 ml-auto"><?php _ex('Name on the card is required.', 'ui', 'memberpress'); ?></span>
    </div>
    <input type="text" name="card-name" class="mepr-form-input stripe-card-name mepr-form-input w-full p-4 text-xl text-zinc-800 bg-amber-200 rounded" required />
  </div>
